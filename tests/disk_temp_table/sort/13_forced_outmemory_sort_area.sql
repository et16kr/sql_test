...
--+SKIP BEGIN;
DROP PROCEDURE DST_COV_FS13_RESTORE_SORT_AREA;
...
CREATE OR REPLACE PROCEDURE DST_COV_FS13_RESTORE_SORT_AREA
AS
...
BEGIN
    ...
    EXECUTE IMMEDIATE 'ALTER SYSTEM SET SORT_AREA_SIZE = ' || V_OLD_SORT_AREA;
END;
/

EXECUTE DST_COV_FS13_RESTORE_SORT_AREA;
