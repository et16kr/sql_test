...
--+SYSTEM bash ./tests/tde/bin/tde_case.sh negative_online_operation;
-- Test Purpose: Verify offline-only TDE operations fail while the tablespace is online.
-- Checks: The encrypted tablespace remains accessible after the expected failure.
-- Manual reference:
