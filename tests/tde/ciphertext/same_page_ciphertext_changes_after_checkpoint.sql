...
-- Test Purpose: Verify dirty checkpoints preserve the encrypted file nonce.
-- Checks: The helper compares copied checkpoint headers and restarts after a follow-up checkpoint.
-- Manual reference:
