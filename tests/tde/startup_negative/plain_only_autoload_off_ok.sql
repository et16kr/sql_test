...
--+SYSTEM bash ./tests/tde/bin/tde_case.sh plain_only_autoload_off_ok;
-- Test Purpose: Start the server with TDE_AUTO_LOAD=0 and no keystore while every MRDB TDE tablespace is plain.
