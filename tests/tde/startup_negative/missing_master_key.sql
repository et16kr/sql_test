...
--+SYSTEM bash ./tests/tde/bin/tde_case.sh negative_missing_master_key;
-- Test Purpose: Verify missing master key history causes startup failure and clean recovery.
