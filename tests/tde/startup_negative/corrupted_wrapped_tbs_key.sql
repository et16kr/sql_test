...
--+SYSTEM bash ./tests/tde/bin/tde_case.sh negative_corrupted_wrapped_tbs_key;
-- Test Purpose: Corrupt the wrapped tablespace key in the checkpoint image header.
